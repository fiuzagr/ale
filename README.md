...
| JavaScript | [eslint](http://eslint.org/), [flow](https://flowtype.org/), [jscs](http://jscs.info/), [jshint](http://jshint.com/), [prettier](https://github.com/prettier/prettier), [prettier-eslint](https://github.com/prettier/prettier-eslint-cli), [prettier-standard](https://github.com/sheerun/prettier-standard), [sonarjs](https://github.com/SonarSource/sonarjs-cli) !!, [standard](http://standardjs.com/), [xo](https://github.com/sindresorhus/xo)
